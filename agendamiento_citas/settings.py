"""
Django settings for agendamiento_citas project.
...
ROOT_URLCONF = 'agendamiento_citas.urls'
...
WSGI_APPLICATION = 'agendamiento_citas.wsgi.application'
